    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <h3><?php echo app('translator')->get('fleet.vendorReport'); ?></h3>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <table class="table table-bordered table-striped table-hover">
            ...
            <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td><?php echo e($vendors[$d->vendor_id]); ?></td>
...
</html><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/reports/print_vendor.blade.php ENDPATH**/ ?>