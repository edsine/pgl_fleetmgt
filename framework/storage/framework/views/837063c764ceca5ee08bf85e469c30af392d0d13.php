...
<li class="breadcrumb-item"><a href="<?php echo e(route("notes.index")); ?>"><?php echo app('translator')->get('fleet.notes'); ?></a></li>
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.add_note'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('fleet.create_note'); ?></h3>
      </div>
...
$(document).ready(function() {
  ...
  $('#customer_id').select2({placeholder: "<?php echo app('translator')->get('fleet.person_incharge'); ?>"});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/notes/create.blade.php ENDPATH**/ ?>