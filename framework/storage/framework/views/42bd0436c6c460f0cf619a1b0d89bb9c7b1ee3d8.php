    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('fleet.manageUsers'); ?> &nbsp; 
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Users add')): ?><a href="<?php echo e(route("users.create")); ?>" class="btn btn-success"><?php echo app('translator')->get('fleet.addUser'); ?></a></h3><?php endif; ?>
      </div>
        ...
        <table class="table" id="data_table">
          ...
          <tfoot>
            <tr>
              <th>
                <?php if($data->count() > 0): ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Users delete')): ?><button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled><?php echo app('translator')->get('fleet.delete'); ?></button><?php endif; ?>
                <?php endif; ?>
              </th>
              <th>#</th>
              <th><?php echo app('translator')->get('fleet.profile_photo'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/users/index.blade.php ENDPATH**/ ?>