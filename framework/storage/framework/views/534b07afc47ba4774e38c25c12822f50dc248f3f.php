...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.driverReport'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('fleet.driverReport'); ?>
        </h3>
      </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <button type="submit" formaction="<?php echo e(url('admin/print-driver-report')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> <?php echo app('translator')->get('fleet.print'); ?></button>
        </div>
        <?php echo Form::close(); ?>
        ...
        <div class="row">
          ...
          <div class="col-md-6 table-responsive">
            <table class="table table-bordered table-striped table-hover" id="myTable">
              <thead>
                <tr>
                  <th scope="row"><?php echo app('translator')->get('fleet.driver'); ?>:</th>
...
var config = {
    ...
    data: {
        ...
        datasets: [{
            label: "<?php echo app('translator')->get('fleet.drivers'); ?>",
    ...
    options: {
        ...
        scales: {
            xAxes: [{
                ...
                scaleLabel: {
                    display: true,
                    labelString: "<?php echo app('translator')->get('fleet.drivers'); ?>"
                }
            }],
            yAxes: [{
                display: true,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/reports/driver.blade.php ENDPATH**/ ?>