...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.vendorReport'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
        <?php echo app('translator')->get('fleet.vendorReport'); ?> &nbsp; <a href="<?php echo e(url('admin/print-vendor-report')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> <?php echo app('translator')->get('fleet.print'); ?></a>
        </h3>
      </div>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-striped table-hover" id="myTable">
                    <thead>
                      <tr>
                        <th scope="row"><?php echo app('translator')->get('fleet.vendor'); ?>:</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/reports/vendor.blade.php ENDPATH**/ ?>