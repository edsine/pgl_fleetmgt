  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp; <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Customer add')): ?><a href="<?php echo e(route("customers.create")); ?>" class="btn btn-success"><?php echo app('translator')->get('fleet.add_new'); ?></a><?php endif; ?>
        ...
        <table class="table" id="data_table" style="padding-bottom: 25px">
          ...
          <tfoot>
            <tr>
              <th>
                <?php if($data->count() > 0): ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Customer delete')): ?><button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled><?php echo app('translator')->get('fleet.delete'); ?></button><?php endif; ?>
                <?php endif; ?>
              </th>
              <th><?php echo app('translator')->get('fleet.name'); ?></th>
              <th><?php echo app('translator')->get('fleet.email'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/customers/index.blade.php ENDPATH**/ ?>