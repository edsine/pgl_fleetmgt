...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.deliquentReport'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('fleet.deliquentReport'); ?>
        </h3>
      </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <button type="submit" formaction="<?php echo e(url('admin/print-deliquent-report')); ?>" class="btn btn-danger" style="margin-right: 10px"><i class="fa fa-print"></i> <?php echo app('translator')->get('fleet.print'); ?></button>
        </div>
        <?php echo Form::close(); ?>
        ...
        <table class="table table-bordered table-striped table-hover"  id="myTable">
          ...
          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><?php echo e($v[$row->vehicle_id]->maker['make']); ?>-<?php echo e($v[$row->vehicle_id]->vehiclemodel['model']); ?>-<?php echo e($v[$row->vehicle_id]['license_plate']); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/reports/delinquent.blade.php ENDPATH**/ ?>