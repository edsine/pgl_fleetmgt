  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ServiceReminders add')): ?><a href="<?php echo e(route('service-reminder.create')); ?>" class="btn btn-success" style="margin-bottom: 5px"><?php echo app('translator')->get('fleet.add_service_reminder'); ?></a><?php endif; ?> &nbsp;
        ...
        <table class="table" id="data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->get('fleet.start_date'); ?> / <?php echo app('translator')->get('fleet.last_performed'); ?> </th>
              <th><?php echo app('translator')->get('fleet.next_due'); ?> (<?php echo app('translator')->get('fleet.date'); ?>)</th>
              <th><?php echo app('translator')->get('fleet.next_due'); ?> (<?php echo app('translator')->get('fleet.meter'); ?>)</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php echo app('translator')->get('fleet.unit'); ?> #: <?php echo e($reminder->vehicle['id']); ?>

                <br>
                <?php echo e($reminder->vehicle->year); ?> <?php echo e($reminder->vehicle->maker->make); ?> <?php echo e($reminder->vehicle->vehiclemodel->model); ?>

                <br>
                <?php echo app('translator')->get('fleet.vin'); ?>:<?php echo e($reminder->vehicle->vin); ?>

                <br>
                <?php echo app('translator')->get('fleet.plate'); ?>:<?php echo e($reminder->vehicle->license_plate); ?>
              ...
              <td>
                ...
                <br>
                <?php echo app('translator')->get('fleet.last_performed'); ?> <?php echo app('translator')->get('fleet.meter'); ?>: <?php echo e($reminder->last_meter); ?>
          ...
          <tfoot>
            <tr>
              <th>
                <?php if($service_reminder->count() > 0): ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ServiceReminders delete')): ?><button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled><?php echo app('translator')->get('fleet.delete'); ?></button><?php endif; ?>
                <?php endif; ?>
              </th>
              <th></th>
              <th><?php echo app('translator')->get('fleet.vehicle'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/service_reminder/index.blade.php ENDPATH**/ ?>