...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.fuelReport'); ?></li>
	...
	<div class="col-md-12">
		<div class="card card-info">
			<div class="card-header">
				<h3 class="card-title"><?php echo app('translator')->get('fleet.fuelReport'); ?>
				</h3>
			</div>
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<button type="submit" formaction="<?php echo e(url('admin/print-fuel-report')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> <?php echo app('translator')->get('fleet.print'); ?></button>
				</div>
				<?php echo Form::close(); ?>
				...
				<table class="table table-bordered table-striped table-hover"  id="myTable">
					<thead>
						<tr>
							...
							<th><?php echo app('translator')->get('fleet.consumption'); ?></th>
					...
					<?php $__currentLoopData = $fuel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td><?php echo e($f->vehicle_data->maker->make); ?>-<?php echo e($f->vehicle_data->vehiclemodel->model); ?>-<?php echo e($f->vehicle_data->license_plate); ?></td>
							<td>
							<b> <?php echo app('translator')->get('fleet.start'); ?>: </b><?php echo e($f->start_meter); ?> <?php echo e(Hyvikk::get('dis_format')); ?>

							<br>
							<b> <?php echo app('translator')->get('fleet.end'); ?>:</b><?php echo e($f->end_meter); ?> <?php echo e(Hyvikk::get('dis_format')); ?>

							</td>
							<td>
								<?php echo e($f->qty); ?> <?php echo e(Hyvikk::get('fuel_unit')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/reports/fuel.blade.php ENDPATH**/ ?>