...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.monthlyReport'); ?></li>
        ...
        <div class="row">
          ...
          <div class="form-group" style="margin-right: 10px">
            ...
            <select id="vehicle_id" name="vehicle_id" class="form-control vehicles" style="width: 250px">
              ...
              <option value="<?php echo e($vehicle->id); ?>" <?php if($vehicle->id == $vehicle_select): ?> selected <?php endif; ?>><?php echo e($vehicle->maker->make); ?>-<?php echo e($vehicle->vehiclemodel->model); ?>-<?php echo e($vehicle->license_plate); ?></option>
          ...
          <button type="submit" formaction="<?php echo e(url('admin/print-monthly-report')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> <?php echo app('translator')->get('fleet.print'); ?></button>
        </div>
        <?php echo Form::close(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/reports/monthly.blade.php ENDPATH**/ ?>