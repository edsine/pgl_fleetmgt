...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.work_orders'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('WorkOrders add')): ?><a href="<?php echo e(route('work_order.create')); ?>" class="btn btn-success"><?php echo app('translator')->get('fleet.create_workorder'); ?></a><?php endif; ?></h3>
      </div>
        ...
        <table class="table" id="data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->get('fleet.personnel'); ?></th>
              ...
              <th><?php echo app('translator')->get('fleet.mechanics'); ?></th>
          ...
          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><?php echo e(($row->mechanic_id)?$row->mechanic->name:""); ?></td>
              <td>
          ...
          <tfoot>
            <tr>
              <th>
                <?php if($data->count() > 0): ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('WorkOrders delete')): ?><button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled><?php echo app('translator')->get('fleet.delete'); ?></button><?php endif; ?>
                <?php endif; ?>
              </th>
              <th><?php echo app('translator')->get('fleet.vehicle'); ?></th>
              <th></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/work_orders/index.blade.php ENDPATH**/ ?>