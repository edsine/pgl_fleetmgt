    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <h3><?php echo app('translator')->get('fleet.driverReport'); ?>&nbsp;<small><?php echo e(date('F', mktime(0, 0, 0, $month_select, 10))); ?>-<?php echo e($year_select); ?></small></h3>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
...
</html><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/reports/print_driver.blade.php ENDPATH**/ ?>