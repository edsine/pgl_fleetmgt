      ...
      <div class="card-body">
        <div class="nav-tabs-custom">
          <ul class="nav nav-pills custom">
            <li class="nav-item"><a class="nav-link active" href="#info-tab" data-toggle="tab"> <?php echo app('translator')->get('fleet.general_info'); ?> <i class="fa"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="#insurance" data-toggle="tab"> <?php echo app('translator')->get('fleet.insurance'); ?> <i class="fa"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="#acq-tab" data-toggle="tab"> <?php echo app('translator')->get('fleet.purchase_info'); ?> <i class="fa"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="#driver" data-toggle="tab"> <?php echo app('translator')->get('fleet.assign_driver'); ?> <i class="fa"></i></a></li>
          </ul>
        </div>
            ...
            <div class="row card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-6">
                   <select name="make_id" class="form-control" required id="make_id">
                     ...
                     <option value="<?php echo e($make->id); ?>" <?php if($make->id == $vehicle->make_id): ?> selected <?php endif; ?>><?php echo e($make->make); ?></option>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                   </select>
                  </div>
                </div>
              ...
              <div class="form-group">
                <?php if(Hyvikk::get('dis_format') == "km"): ?>
				          <?php if(Hyvikk::get('fuel_unit') == "gallon"): ?> <?php echo Form::label('average', __('fleet.average')."(".__('fleet.kmpg').")", ['class' => 'col-xs-5 control-label']); ?> <?php else: ?> <?php echo Form::label('average', __('fleet.average')."(".__('fleet.kmpl').")", ['class' => 'col-xs-5 control-label']); ?> <?php endif; ?>
				        <?php else: ?>
				          <?php if(Hyvikk::get('fuel_unit') == "gallon"): ?><?php echo Form::label('average', __('fleet.average')."(".__('fleet.mpg').")", ['class' => 'col-xs-5 control-label']); ?> <?php else: ?> <?php echo Form::label('average', __('fleet.average')."(".__('fleet.mpl').")", ['class' => 'col-xs-5 control-label']); ?> <?php endif; ?>
                <?php endif; ?>
                <div class="col-xs-6">
                ...
                <div class="form-group">
                  <?php if(Hyvikk::get('dis_format') == "km"): ?>
                  <?php echo Form::label('int_mileage', __('fleet.intMileage')."(".__('fleet.km').")", ['class' => 'col-xs-5 control-label']); ?>

                <?php else: ?>
                <?php echo Form::label('int_mileage', __('fleet.intMileage')."(".__('fleet.miles').")", ['class' => 'col-xs-5 control-label']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-6">
                   <select name="color_id" class="form-control" required id="color_id">
                     ...
                     <option value="<?php echo e($color->id); ?>" <?php if($color->id == $vehicle->color_id): ?>selected <?php endif; ?>><?php echo e($color->color); ?></option>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                   </select>
                  </div>
                </div>
            ...
            <div class="row card-body" >
              <div class="col-md-12">
                <div class="card card-info">
                  <div class="card-header">
                    <h3 class="card-title"><?php echo app('translator')->get('fleet.acquisition'); ?> :<strong><?php if($vehicle->make_id): ?><?php echo e($vehicle->maker->make); ?><?php endif; ?> <?php if($vehicle->model_id): ?><?php echo e($vehicle->vehiclemodel->model); ?><?php endif; ?> <?php echo e($vehicle->license_plate); ?></strong>
                    </h3>
                  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/vehicles/edit.blade.php ENDPATH**/ ?>