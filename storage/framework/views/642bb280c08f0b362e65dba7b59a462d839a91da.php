    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <h3><?php echo app('translator')->get('fleet.yearlyReport'); ?>&nbsp;<small><?php echo e($year_select); ?></small></h3>
          <?php if($vehicle != null): ?><h4><?php echo e($vehicle->maker['make']); ?>-<?php echo e($vehicle->vehiclemodel['model']); ?>-<?php echo e($vehicle['license_plate']); ?></h4> <?php endif; ?>
        </div>
      </div>
      <div class="row">
        <div class="col-md-4">
          <h3><?php echo app('translator')->get('fleet.income'); ?>-<?php echo app('translator')->get('fleet.expense'); ?></h3>
        ...
        <div class="col-md-4">
          <h3><?php echo app('translator')->get('fleet.incomeByCategory'); ?></h3>
          <table class="table table-bordered table-striped table-hover">
            <?php ($tot = 0); ?>
            ...
            <thead>
              <tr>
                ...
                <td><?php echo e(Hyvikk::get("currency")); ?><?php echo e($tot); ?></td>
              </tr>
            </thead>
            <tbody>
              <?php $__currentLoopData = $income_by_cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-md-4">
          <h3><?php echo app('translator')->get('fleet.expensesByCategory'); ?></h3>
          <table class="table table-bordered table-striped table-hover">
            <thead>
              <tr>
                <?php ($tot = 0); ?>
...
</html><?php /**PATH C:\laragon\www\fleet-manager\framework\resources\views/reports/print_yearly.blade.php ENDPATH**/ ?>