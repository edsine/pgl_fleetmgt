...
class UserAccessController extends Controller
{
    ...
    public function index()
    {
        ...
        // $user = \App\Model\User::on('mysql')->permission('User list')->get();
        //$permissionNames = \App\Model\User::role('Customer')->first();
        //$permissionNames = Auth::user()->user_type;
        //echo $permissionNames->id;
    }
